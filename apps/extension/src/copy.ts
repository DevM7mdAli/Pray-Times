export const EXTENSION_COPY = {
  ar: {
    ...
    methodNeedsCity: "اختر مدينة أولًا لعرض طرق الحساب",
    methodOverridden: "اختيارك، بدل الافتراضي للدولة",
    iqamahTitle: "وقت الإقامة",
    iqamahDescription:
      "اختر وقتًا ثابتًا أو عدد الدقائق بعد دخول وقت الصلاة. تحفظ الإعدادات لهذه المدينة فقط.",
    iqamahNeedsCity: "اختر مدينة أولًا لضبط أوقات الإقامة.",
    iqamahNotSet: "غير محدد",
    iqamahOffset: "بعد الأذان",
    iqamahExact: "وقت ثابت",
    iqamahMinutes: "دقيقة",
    iqamahShort: "الإقامة",
  ...
  en: {
    ...
    methodNeedsCity: "Choose a city first to view calculation methods",
    methodOverridden: "Your choice, replacing the country default",
    iqamahTitle: "Iqamah time",
    iqamahDescription:
      "Choose an exact time or minutes after adhan. Settings are saved only for this city.",
    iqamahNeedsCity: "Choose a city first to configure iqamah times.",
    iqamahNotSet: "Not set",
    iqamahOffset: "After adhan",
    iqamahExact: "Exact time",
    iqamahMinutes: "min",
    iqamahShort: "Iqamah",
